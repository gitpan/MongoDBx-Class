...
BEGIN {
  $MongoDBx::Class::Meta::AttributeTraits::VERSION = '0.4';
}
...
BEGIN {
  $MongoDBx::Class::Meta::AttributeTraits::Parsed::VERSION = '0.4';
}
...
BEGIN {
  $Moose::Meta::Attribute::Custom::Trait::Parsed::VERSION = '0.4';
}
